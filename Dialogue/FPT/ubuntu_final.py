...
def main():
    ...
    parser.add_argument("--train_file",
                        default="/mnt/public/home/lvwp/process/UDC_/FP/FP/ubuntu_data/ubuntu_post_train.pkl",
                        type=str,
    ...
    parser.add_argument("--output_dir",
                        default="/mnt/public/home/lvwp/process/UDC_/FP/FP/FPT/PT_checkpoint/ubuntu",
                        type=str,
    ...
    train_dataloader = DataLoader(train_dataset, sampler=train_sampler, batch_size=args.train_batch_size,num_workers=2, drop_last=False)
    ...
    for epoch in trange(1, int(args.num_train_epochs) + 1, desc="Epoch"):
        ...
        for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration",position=0)):
            ...
            model.train()
            optimizer.zero_grad()
            linshi = model(input_ids=input_ids,attention_mask= input_mask, token_type_ids=segment_ids)

            prediction_scores = linshi[0]
            seq_relationship_score = linshi[1]
