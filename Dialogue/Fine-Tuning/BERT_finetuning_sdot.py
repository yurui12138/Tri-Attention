...
from transformers.modeling_bert_sdot import BertForSequenceClassification
...
class NeuralNetwork(nn.Module):
    ...
    def __init__(self, args, deep_number):
        ...
        self.bert_config = config_class.from_pretrained(
            '/mnt/public/home/lvwp/process/SPM/pytorch_pretrained_bert/bert-base-chinese', num_labels=1)
        self.bert_tokenizer = BertTokenizer.from_pretrained(
            '/mnt/public/home/lvwp/process/SPM/pytorch_pretrained_bert/bert-base-chinese',
        ...
        self.bert_model = model_class.from_pretrained(
            '/mnt/public/home/lvwp/process/SPM/pytorch_pretrained_bert/bert-base-chinese', config=self.bert_config,
            deep_number=self.deep_number)
    ...
    def evaluate(self, dev, is_test=False):
        ...
        with open('/mnt/public/home/lvwp/process/UDC_/FP/FP/Fine-Tuning/result/new/sdot.txt', "a") as writer:
