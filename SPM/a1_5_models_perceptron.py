...
class BertModel(nn.Module):
    def __init__(self, requires_grad=True, num_labels=2, depth=3, md=1):
    ...
    def forward(self, batch_seqs, batch_seq_masks, batch_seq_segments, batch_seqs_s1, batch_seq_masks_s1, batch_seqs_s2, batch_seq_masks_s2, labels, t, md, depth=3):
