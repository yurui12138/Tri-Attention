...
from a2_2_utils_copy_1 import train, validate, test

from a2_3_models_dot_copy_1 import BertModel
# from a2_4_models_dot_scale_copy_1 import BertModel
# from a2_5_models_perceptron_copy_1 import BertModel
# from a2_6_models_general_copy_1 import BertModel
...
def model_train_validate_test(train_df, dev_df, test_df, target_dir,
                              ...
                              if_save_model=True,
                              checkpoint=None):
    bertmodel = BertModel(requires_grad=True, num_labels=num_labels)
    ...
    _, _, test_accuracy, predictions = validate(model, test_loader, mode='test')
    ...
    for epoch in range(start_epoch, epochs + 1):
        ...
        epoch_time, epoch_loss, epoch_accuracy = train(model, train_loader, optimizer, epoch, max_grad_norm, t)
        t = t / 1
        ...
        if epoch_accuracy < best_score:
            ...
            if (if_save_model):
                torch.save({"epoch": epoch,
                           ...
                           os.path.join(target_dir, "best_per_1.pth.tar"))
            ...
            test_prediction.to_csv(os.path.join(target_dir, "test_prediction_1.csv"), index=False)
