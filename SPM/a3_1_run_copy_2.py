...
from a3_2_utils_copy_2 import train, validate, test

from a3_3_models_dot_copy_2 import BertModel
# from a3_4_models_dot_scale_copy_2 import BertModel
# from a3_5_models_perceptron_copy_2 import BertModel
# from a3_6_models_general_copy_2 import BertModel
        ...
        if epoch_accuracy < best_score:
            ...
            if (if_save_model):
                torch.save({"epoch": epoch,
                           ...
                           os.path.join(target_dir, "best_per_2.pth.tar"))
            ...
            test_prediction.to_csv(os.path.join(target_dir, "test_prediction_2.csv"), index=False)
