...
class Multil_Atten(nn.Module):
    ...
    def forward(self, sen1, sen2, context_sens, attention_mask=None):
        ...
        lin = torch.matmul(query_layer, key_layer.transpose(-1, -2))
        np.save('/mnt/public/home/lvwp/process/SPM/lin.npy', lin.cpu())
        ...
        np.save('/mnt/public/home/lvwp/process/SPM/attention_scores.npy', attention_scores.cpu())
        print(attention_scores.size(9))
